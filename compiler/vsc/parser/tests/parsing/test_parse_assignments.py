...
@pytest.mark.parametrize(
    ...
    pytest.param("let _a = true", id="cname_1"),
...
@pytest.mark.parametrize(
    ...
    pytest.param("let x, = some_func()", ErrorCode.SYNTAX_INVALID_CHARACTER, id="missing_multi_assignment_second_var"),
    pytest.param("let x y = some_func()", ErrorCode.SYNTAX_INVALID_IDENTIFIER, id="missing_multi_assignment_comma"),
    pytest.param("let x, y = ", ErrorCode.SYNTAX_MISSING_VALUE_AFTER_EQUALS, id="missing_value_after_=_multi_assignment"),
    pytest.param("x, y = some_func()", ErrorCode.SYNTAX_INVALID_CHARACTER, id="missing_let_multi_assignment"),
    pytest.param("let x = a > b > c", ErrorCode.SYNTAX_INVALID_CHARACTER, id="chaining_not_allowed_for_comparison"),
