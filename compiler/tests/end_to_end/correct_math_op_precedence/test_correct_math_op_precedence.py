...
def test_correct_math_op_precedence_const_folding():
    """
    ...
    script_content = load_script("tests/end_to_end/correct_math_op_precedence/const_folding.vs")
    ...
    assert len(final_instruction["srcs"]) == 1
    ...
    assert final_instruction["op"] == OpCode.copy_S_S.value
