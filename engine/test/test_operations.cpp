...
INSTANTIATE_TEST_SUITE_P(
    ...
    ::testing::Values(
        ...
        std::make_tuple(R"({"simulation_config":{"num_trials":1},"output_variable_index":1,"variable_registry":["A","B"],"per_trial_steps":[{"type":"literal_assignment","result_index":0,"value":10},{"type":"execution_assignment","result_index":1,"function":"log","args":[{"type":"scalar_literal","value":10.0}]}]})", TrialValue(std::log(10.0)), false),
        std::make_tuple(R"({"simulation_config":{"num_trials":1},"output_variable_index":1,"variable_registry":["A","B"],"per_trial_steps":[{"type":"literal_assignment","result_index":0,"value":10},{"type":"execution_assignment","result_index":1,"function":"log10","args":[{"type":"scalar_literal","value":10.0}]}]})", TrialValue(std::log10(10.0)), false),
        std::make_tuple(R"({"simulation_config":{"num_trials":1},"output_variable_index":1,"variable_registry":["A","B"],"per_trial_steps":[{"type":"literal_assignment","result_index":0,"value":2},{"type":"execution_assignment","result_index":1,"function":"exp","args":[{"type":"scalar_literal","value":2.0}]}]})", TrialValue(std::exp(2.0)), false),
        std::make_tuple(R"({"simulation_config":{"num_trials":1},"output_variable_index":1,"variable_registry":["A","B"],"per_trial_steps":[{"type":"literal_assignment","result_index":0,"value":0},{"type":"execution_assignment","result_index":1,"function":"sin","args":[{"type":"scalar_literal","value":0.0}]}]})", TrialValue(std::sin(0.0)), false),
        std::make_tuple(R"({"simulation_config":{"num_trials":1},"output_variable_index":1,"variable_registry":["A","B"],"per_trial_steps":[{"type":"literal_assignment","result_index":0,"value":0},{"type":"execution_assignment","result_index":1,"function":"cos","args":[{"type":"scalar_literal","value":0.0}]}]})", TrialValue(std::cos(0.0)), false),
        std::make_tuple(R"({"simulation_config":{"num_trials":1},"output_variable_index":1,"variable_registry":["A","B"],"per_trial_steps":[{"type":"literal_assignment","result_index":0,"value":0},{"type":"execution_assignment","result_index":1,"function":"tan","args":[{"type":"scalar_literal","value":0.0}]}]})", TrialValue(std::tan(0.0)), false)));
...
INSTANTIATE_TEST_SUITE_P(
    ...
    ::testing::Values(
        ...
        std::make_tuple(R"({"simulation_config":{"num_trials":1},"output_variable_index":0,"variable_registry":["C","base","rate"],"per_trial_steps":[{"type":"literal_assignment","result_index":1,"value":100},{"type":"literal_assignment","result_index":2,"value":0.1},{"type":"execution_assignment","result_index":0,"function":"grow_series","args":[{"type":"variable_index","value":1},{"type":"variable_index","value":2},{"type":"scalar_literal","value":3.0}]}]})", TrialValue(std::vector<double>{110.0, 121.0, 133.1}), true),
        ...
        std::make_tuple(R"({"simulation_config":{"num_trials":1},"output_variable_index":2,"variable_registry":["start","end","C"],"per_trial_steps":[{"type":"literal_assignment","result_index":0,"value":10},{"type":"literal_assignment","result_index":1,"value":50},{"type":"execution_assignment","result_index":2,"function":"interpolate_series","args":[{"type":"variable_index","value":0},{"type":"variable_index","value":1},{"type":"scalar_literal","value":5.0}]}]})", TrialValue(std::vector<double>{10.0, 20.0, 30.0, 40.0, 50.0}), true),
        ...
        std::make_tuple(R"({"simulation_config":{"num_trials":1},"output_variable_index":3,"variable_registry":["A", "B", "C_in", "C"],"per_trial_steps":[{"type":"literal_assignment", "result_index":0, "value":5.0},{"type":"literal_assignment", "result_index":1, "value":[10.0, 20.0, 30.0]},{"type":"literal_assignment", "result_index":2, "value":40.0},{"type":"execution_assignment","result_index":3,"function":"compose_vector","args":[{"type":"variable_index", "value":0},{"type":"variable_index", "value":1},{"type":"variable_index", "value":2}]}]})", TrialValue(std::vector<double>{5.0, 10.0, 20.0, 30.0, 40.0}), true),
...
INSTANTIATE_TEST_SUITE_P(
    ...
    DeterministicEngineTest,
    ::testing::Values(
        std::make_tuple(R"({"simulation_config":{"num_trials":1},"output_variable_index":1,"variable_registry":["my_vec", "A"],"per_trial_steps":[{"type":"literal_assignment","result_index":0,"value":[1.0,2.0,3.0]},{"type":"execution_assignment","result_index":1,"function":"delete_element","args":[{"type":"variable_index","value":0}, {"type":"scalar_literal","value":1.0}]}]})", TrialValue(std::vector<double>{1.0, 3.0}), true),
        std::make_tuple(R"({"simulation_config":{"num_trials":1},"output_variable_index":1,"variable_registry":["my_vec", "A"],"per_trial_steps":[{"type":"literal_assignment","result_index":0,"value":[1.0,2.0,3.0]},{"type":"execution_assignment","result_index":1,"function":"delete_element","args":[{"type":"variable_index","value":0}, {"type":"scalar_literal","value":0.0}]}]})", TrialValue(std::vector<double>{2.0, 3.0}), true),
        std::make_tuple(R"({"simulation_config":{"num_trials":1},"output_variable_index":1,"variable_registry":["my_vec", "A"],"per_trial_steps":[{"type":"literal_assignment","result_index":0,"value":[1.0,2.0,3.0]},{"type":"execution_assignment","result_index":1,"function":"delete_element","args":[{"type":"variable_index","value":0}, {"type":"scalar_literal","value":2.0}]}]})", TrialValue(std::vector<double>{1.0, 2.0}), true),
        std::make_tuple(R"({"simulation_config":{"num_trials":1},"output_variable_index":1,"variable_registry":["my_vec", "A"],"per_trial_steps":[{"type":"literal_assignment","result_index":0,"value":[1.0,2.0,3.0]},{"type":"execution_assignment","result_index":1,"function":"delete_element","args":[{"type":"variable_index","value":0}, {"type":"scalar_literal","value":-1.0}]}]})", TrialValue(std::vector<double>{1.0, 2.0}), true)));